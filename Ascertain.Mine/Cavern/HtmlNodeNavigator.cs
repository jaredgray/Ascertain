// Ascertain.Mine V1.0 - Simon Mourier <simon underscore mourier at hotmail dot com>
using System;
...
namespace Ascertain.Mine
{
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            Ascertain.Mine.Trace.WriteLine(string.Format("oid={0},n={1},a={2},v={3},{4}", GetHashCode(), nodename, _attindex, nodevalue, traceValue), "N!" + name);
        }
